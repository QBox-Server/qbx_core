return {
    ...
    pauseMapText = 'Mythic Trails Roleplay', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    discord = {
        ...
        appId = '1439766494954127372', -- This is the Application ID (Replace this with you own)

        largeIcon = { -- To set this up, visit https://forum.cfx.re/t/how-to-updated-discord-rich-presence-custom-image/157686
            icon = 'mtrp1024', -- Here you will have to put the image name for the 'large' icon.
            text = 'Mythic Trails RP', -- Here you can add hover text for the 'large' icon.
        },

        smallIcon = {
            icon = 'mtrp512', -- Here you will have to put the image name for the 'small' icon.
            text = 'Join Today!', -- Here you can add hover text for the 'small' icon.
        },

        firstButton = {
            text = 'Join the Discord',
            link = 'https://discord.gg/UNvEyv44JW',
        },

        secondButton = {
            text = 'Connect to Server',
            link = 'https://cfx.re/join/4zpom5',
        }
    },
